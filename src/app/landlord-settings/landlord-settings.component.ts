...
@Component({
  selector: 'app-landlord-settings',
  templateUrl: './landlord-settings.component.html',
  styleUrls: ['./landlord-settings.component.scss']
})
export class LandlordSettingsComponent implements OnInit {
  user_id : any;
  iconSelected : string;
