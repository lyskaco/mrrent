...
@Component({
  selector: 'app-tennant-inbox',
  templateUrl: './tennant-inbox.component.html',
  styleUrls: ['./tennant-inbox.component.scss'],
  animations: [
    trigger('messageWindowTen', [
        transition(':enter', [
...
export class TennantInboxComponent implements OnInit {
  user_id : number;
